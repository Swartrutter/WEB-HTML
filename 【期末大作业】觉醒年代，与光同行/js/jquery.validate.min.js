(function(t) {
    t.extend(t.fn, {
        ...
        messages: { required: "此字段必填！", remote: "请修复此字段！", email: "请输入有效的电子邮件地址！", url: "请输入一个有效的URL！", date: "请输入有效日期！", dateISO: "请输入有效的日期(ISO)！", number: "请输入一个有效的数字！", digits: "请只输入数字！", creditcard: "请输入有效的信用卡号码！", equalTo: "请再次输入相同的值！", maxlength: t.validator.format("请输入不超过{0}的字符！"), minlength: t.validator.format("请输入至少{0}字符！"), rangelength: t.validator.format("请输入一个长度在{0}到{1}之间的值！"), range: t.validator.format("请输入一个介于{0}和{1}之间的值！"), max: t.validator.format("请输入一个小于或等于{0}的值！"), min: t.validator.format("请输入大于或等于{0}的值！") },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
                function e(e) {
